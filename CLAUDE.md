...
- 七张核心表（users / contents / prompt_templates / prompt_versions / generation_records / user_settings / publish_records）
...
后端使用 Express + AdminJS + Redis（可选），七张 MySQL 兼容表，前端 localStorage 离线降级。
